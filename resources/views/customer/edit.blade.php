...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Изменить данные о покупателе') }}
        </h2>
    </x-slot>
            ...
            <div class="p-6 text-gray-900">
                <form action="{{ route('customers.update', $customer->id) }}" method="POST">
                    ...
                    <div class="py-2">
                        ...
                        <x-text-input id="email" class="block mt-1 w-full" type="text" name="email" :value="old('email', $customer->email)" required />
                    ...
                    <div class="py-2">
                        ...
                        <x-text-input id="number_card" class="block mt-1 w-full" type="text" name="number_card" :value="old('number_card', $customer->number_card)" required />
